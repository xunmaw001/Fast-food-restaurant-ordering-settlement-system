        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="桌台" prop="zhuotaiTypes">
                        <el-select v-model="ruleForm.zhuotaiTypes" :disabled="ro.zhuotaiTypes" placeholder="请选择桌台">
                            <el-option
                                v-for="(item,index) in zhuotaiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="桌台" prop="zhuotaiValue">
                        <el-input v-model="ruleForm.zhuotaiValue"
                            placeholder="桌台" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zhuotaiTypes: [
                              { required: true, message: '桌台不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuotai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhuotaiTypesOptions = data.data.list;
                    }
                });
                this.$http({
