        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='caipin'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品" prop="caipinId">
                        <el-select v-model="ruleForm.caipinId" :disabled="ro.caipinId" filterable placeholder="请选择商品" @change="caipinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="caipinName">
                        <el-input v-model="caipinForm.caipinName"
                                  placeholder="商品名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品名称" prop="caipinName">
                ...
                <el-col :span="24" v-if="sessionTable !='caipin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.caipinPhoto" label="商品图片" prop="caipinPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinPhoto" label="商品图片" prop="caipinPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="caipinValue">
                        <el-input v-model="caipinForm.caipinValue"
                                  placeholder="商品类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品类型" prop="caipinValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="caipinKucunNumber">
                        <el-input v-model="caipinForm.caipinKucunNumber"
                                  placeholder="商品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品库存" prop="caipinKucunNumber">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="caipinOldMoney">
                        <el-input v-model="caipinForm.caipinOldMoney"
                                  placeholder="商品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品原价" prop="caipinOldMoney">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="caipinClicknum">
                        <el-input v-model="caipinForm.caipinClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="caipinClicknum">
                ...
                <el-col :span="24" v-if="sessionTable !='yonghu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghuPhoto" label="员工头像" prop="yonghuPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuPhoto" label="员工头像" prop="yonghuPhoto">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   yonghuId: [
                              { required: true, message: '所属员工不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
