<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='houcu'"  label='后厨姓名' prop="houcuName">
               <el-input v-model="ruleForm.houcuName"  placeholder='后厨姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='houcu'"  label='后厨手机号' prop="houcuPhone">
               <el-input v-model="ruleForm.houcuPhone"  placeholder='后厨手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='houcu'"  label='电子邮箱' prop="houcuEmail">
               <el-input v-model="ruleForm.houcuEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.houcuName)&& 'houcu'==this.flag){
                             this.$message.error('后厨姓名不能为空');
                             return
                         }

                             if( 'houcu' ==this.flag && this.ruleForm.houcuPhone&&(!isMobile(this.ruleForm.houcuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                             if( 'houcu' ==this.flag && this.ruleForm.houcuEmail&&(!isEmail(this.ruleForm.houcuEmail))){
