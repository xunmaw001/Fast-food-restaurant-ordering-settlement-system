...
public class CaipinOrderEntity<T> implements Serializable {
     ...
     * 桌台
     */
    @TableField(value = "zhuotai_types")

    private Integer zhuotaiTypes;
	 ...
	 * 设置：桌台
	 */
    public Integer getZhuotaiTypes() {
        return zhuotaiTypes;
    }
    ...
    public void setZhuotaiTypes(Integer zhuotaiTypes) {
        this.zhuotaiTypes = zhuotaiTypes;
    }
    /**
	 * 设置：实付价格
	 */
