...
//                            caipinOrderEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            caipinOrderEntity.setBuyNumber(Integer.valueOf(data.get(0)));   //购买数量 要改的
//                            caipinOrderEntity.setZhuotaiTypes(Integer.valueOf(data.get(0)));   //桌台 要改的
...
//                            caipinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer zhuotaiTypes = Integer.valueOf(String.valueOf(params.get("zhuotaiTypes")));//桌台
        ...
        for (Map<String, Object> map : caipins) {
           //取值
            ...
            caipinOrderEntity.setYonghuId(userId);//员工
            caipinOrderEntity.setBuyNumber(buyNumber);//购买数量 ？？？？？？
            caipinOrderEntity.setZhuotaiTypes(zhuotaiTypes);//桌台 ？？？？？？
